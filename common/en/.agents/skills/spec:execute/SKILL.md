...
3. Write `.agentflow/runs/<run-id>/dispatch/developer-001.md` with authoritative `agentflow/` document paths, allowed source/test write scope, required tests, and Developer output paths.
