...
3. 写 `.agentflow/runs/<run-id>/dispatch/developer-001.md`，列出 authoritative `agentflow/` 文档路径、允许写入的源码/测试范围、required tests 和 Developer 输出路径。
...
16. 写 `.agentflow/runs/<run-id>/summary.md`，包含结果、证据、归档计划，以及 commit 或 no-op 计划。
