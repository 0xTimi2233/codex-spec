...
读取 dispatch 列出的产品规则、产品知识文件、planning inputs 和当前 run 文件。写入 dispatch 列出的 PM 产物。只在 `$spec:plan` 且 dispatch 明确要求时更新 `agentflow/vision.md` 或 `agentflow/roadmap.md`。
