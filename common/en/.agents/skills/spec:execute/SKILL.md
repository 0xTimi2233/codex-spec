...
3. Write `codexspec/runtime/runs/<run-id>/dispatch/developer-001.md` with authoritative `codexspec/` document paths, allowed source/test write scope, required tests, and Developer output paths.
...
16. Write `codexspec/runtime/runs/<run-id>/summary.md` with result, evidence, archive plan, and commit or no-op plan.
