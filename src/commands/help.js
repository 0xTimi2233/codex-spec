...
const COMMANDS = {
  init: `codex-spec init [--lang en|zh] [--model middle|high|xhigh] [--fast off|on] [--target <dir>] [--force]\n\nCreate project-local Codex workflow files. Default language is English. Default model profile is middle and fast mode is off.`,
